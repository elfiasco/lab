...
gSymIndex = NaN .* ones(1, 1);
stepLengths = cell(1, 1);
leftStepLengths = cell(1, 1);
rightStepLengths = cell(1, 1);
stepTimes = cell(1, 1);
leftStepTimes = cell(1, 1);
rightStepTimes = cell(1, 1);
...
stepCountLB = 0;%stepCount(2);
stepCountLC = 0;%stepCount(3);
stepCountLD = 0;%stepCount(4);
